...
export default function SteamWishlistSection() {
    ...
    <>
      ...
      <section className="section" ref={ref}>
        <div className="imageWide">
          <img src="/assets/img/eonsAwayBg.png" alt="Eons Away World" />
          <div className="imageWide__content">
            <motion.div
              className="imageWide__content-inner"
